...
namespace aoiro
{
    namespace graphics
    {
        ...
        GLuint Shader::load()
        {
            ...
            std::string vstring = FileUtils::read_file(m_VerPath);
            std::string fstring = FileUtils::read_file(m_FragPath);
            ...
            if(result == GL_FALSE)
            {
                ...
                std::cout<<"vertex shader compiles error:\n";
            ...
            if(result == GL_FALSE)
            {
                ...
                std::cout<<"fragment shader compiles error:\n";
                std::cout<<&error[0]<<std::endl;
